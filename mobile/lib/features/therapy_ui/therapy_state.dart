...
extension _AppThemeX on _AppTheme {
  ...
  Color get plaqueBorder {
    switch (this) {
      ...
      case _AppTheme.space:       return const Color(0xFFEDE7F6);
  ...
  Color get bgMid {
    switch (this) {
      ...
      case _AppTheme.space:       return const Color(0xFFE3F2FD);
  ...
  Color get bgBot {
    switch (this) {
      ...
      case _AppTheme.space:       return const Color(0xFFF3E5F5);
